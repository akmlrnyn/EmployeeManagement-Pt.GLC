  ...
  <div class="w-4/5 mx-auto mt-4">
    ...
    >
      <div class="bg-violet-200 opacity-90 py-2 px-4">
        <h2 class="text-base sm:text-xl font-semibold text-violet-700">Your All <span class="font-light">Permissions ({{ $permission->count() }})</span></h2>
      </div>
      ...
      <ul class="divide-y divide-gray-200">
        ...
        <li class="flex lg:flex-row flex-col sm:items-center py-4 px-6">
          ...
          <div class="flex-1">
            ...
            <p class="text-gray-600 text-xs sm:text-base">{{ $item->amount_of_times }} Minute</p>
