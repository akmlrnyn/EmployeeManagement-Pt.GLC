<x-app-layout>
    <div class="mx-2">
    <div class="w-full mx-auto sm:w-3/5 my-4 bg-white shadow-lg border border-gray-200 rounded-lg shadow dark:bg-white dark:border-gray-100">
        ...
        <h2 class="text-gray-700 text-xl sm:text-3xl font-bold px-4 py-1 pt-2 sm:pt-3">Salary Details on {{ $slip->month }}</h2>
        <p class="text-gray-700 text-xs sm:text-base font-normal px-4 ">{{ date('d M Y', strtotime($slip->created_at) )}}</p>
        <hr>
