<x-app-layout>
  <div class="w-5/6 sm:w-4/5 mx-auto mt-4">
    ...
    <div class="flex flex-col text-start sm:text-end gap-5 mt-5">
      <div>
        <button type="submit" data-modal-target="reset-modal" data-modal-toggle="reset-modal">
      ...
      <div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
              <div class="relative bg-white rounded-lg shadow ">
                <div class="p-4 md:p-5 text-center">
                  ...
                  <button  type="button" data-modal-hide="delete-modal" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-xs font-medium px-4 py-2.5 hover:text-gray-900">No, cancel</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <form action="{{ route('leaverequest.reset') }}" method="post">
          @method('PATCH')
          @csrf
          <div id="reset-modal" tabindex="1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
              <div class="relative bg-white rounded-lg shadow ">
                <div class="p-4 md:p-5 text-center">
                  <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                  ...
                  <button  type="button" data-modal-hide="reset-modal" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-xs font-medium px-4 py-2.5 hover:text-gray-900">No, cancel</button>
                </div>
              </div>
            </div>
          </div>
