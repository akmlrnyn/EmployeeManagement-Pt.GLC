                        ...
                        <li class="py-3 sm:py-4">
                            <div class="flex flex-col sm:flex-row items-center">
                                ...
                                <div class="flex-1 min-w-0 sm:ms-4">
                                    ...
                                    <p class="text-center sm:text-start text-xs sm:text-sm text-gray-500 truncate dark:text-gray-400">
                                        {{ $item->month }}
                                    </p>
                                </div>
                                <div class="flex flex-col sm:flex-row mt-2 sm:mt-0 gap-2 items-center text-xs sm:text-base font-semibold text-gray-900 ">
