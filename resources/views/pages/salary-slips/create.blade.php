<x-app-layout>
    <div class="w-5/6 sm:w-4/5 mx-auto mt-4">
        <a href="{{ route('salary-slips.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" height="20" width="18.5" viewBox="0 0 448 512">
        ...
        <div class="mt-6">
                ...
                <div
                    ...
                    <dl class="sm:space-y-2">
                        <div class="flex gap-2">
                            ...
                            <dt class="text-xs sm:text-sm font-medium text-red-500">You have no staff to make new slip!</dt>
                        </div>
            ...
            <ul class="divide-y divide-gray-200 bg-white mx-auto my-2 sm:my-5 rounded-lg shadow-lg">
                ...
                <li class="flex items-center py-4 px-6">
                    ...
                    <img class="w-8 h-8 sm:w-12 sm:h-12 rounded-full object-cover mr-4"
                        src="{{ url('img/logo_company.png') }}" alt="User avatar" />
                    <div class="flex-1">
