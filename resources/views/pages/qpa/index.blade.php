    ...
    <div class="w-5/6 sm:w-4/5 mx-auto mt-4 pb-6">
        ...
        <div class="mt-6">
            <section class="grid gap-6 my-6 md:grid-cols-3">
                <div class="p-3 sm:p-6 bg-white transition ease-in duration-200 shadow hover:shadow-xl rounded sm:rounded-2xl">
                ...
                <ul role="list">
                    ...
                    <li class="flex justify-between gap-x-6 py-3">
                        ...
                        <div class="min-w-0 flex-auto">
                            ...
                            @elseif ($item->qpa <= 69)
                            <p class="mt-1 text-xs sm:text-sm text-red-500">{{ $item->qpa }}</p>
                            @endif
                        </div>
                        </div>
