            ...
            >
              ...
              <div class="flex items-center p-4 bg-white rounded shadow-md">
                ...
                <div class="flex-grow flex flex-col ml-4">
                  <span class="text-xs sm:text-base font-medium">QPA</span>
                  <div class="flex items-center justify-between">
              ...
              <div class="flex items-center p-4 bg-white rounded shadow-md">
                ...
                <div class="flex-grow flex flex-col ml-4">
                  <span class="text-xs sm:text-base font-medium">Salaries</span>
                  <div class="flex items-center justify-between">
                    <span class="text-xs sm:text-base text-gray-500 text-sm"
              ...
              <div class="flex items-center p-4 bg-white rounded shadow-md">
                ...
                <div class="flex-grow flex flex-col ml-4">
                  <span class="text-xs sm:text-base font-medium">Refresh app cache</span>
                  <div class="flex items-center justify-between">
                    <span class="text-xs sm:text-base text-gray-500 text-sm"
                      >With One Click</span
                    >
